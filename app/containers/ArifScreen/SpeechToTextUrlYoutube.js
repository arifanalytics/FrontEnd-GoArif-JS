...
function SpeechToTextUrlYoutube() {
  ...
  return (
    <div>
      <PapperBlock title="Masukkan Link YouTube" icon="ion-ios-images-outline" whiteBg desc="Pastikan Anda memasukkan URL YouTube dengan benar.">
        <div className={classes.container}>
          <div className={classes.leftSection}>
            <form className={classes.leftSection} autoComplete="off">
              <FormControl variant="standard" className={classes.formControl}>
                <InputLabel htmlFor="url">Url YouTube</InputLabel>
