...
function SpeechToTextUrlYoutube() {
  const {
    classes
  } = useStyles();
  ...
  const handleTranscribe = async () => {
    ...
    try {
      const response = await axios.post(
        'https://arifbackend-upm3c5mlxq-et.a.run.app/Transcribe/SpeechUrlGoogleDriveShareToText',
        requestData,
        {
          headers: {
  ...
  return (
    <div>
      <PapperBlock title="Masukkan Link Drive" icon="ion-ios-images-outline" whiteBg desc="Pastikan tautan Google Drive Anda telah diatur agar dapat diakses secara publik dan merupakan URL berbagi.">
        <div className={classes.container}>
          <div className={classes.leftSection}>
            <form className={classes.leftSection} autoComplete="off">
              <FormControl variant="standard" className={classes.formControl}>
                <InputLabel htmlFor="url">Url Drive</InputLabel>
...
export default SpeechToTextUrlYoutube;
