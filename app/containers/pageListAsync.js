...
export const SpeechToTextUrl = loadable(() =>
  import('./ArifScreen/SpeechToTextUrl'), {
  fallback: <Loading />,
});
export const SpeechToTextUrlYoutube = loadable(() =>
  import('./ArifScreen/SpeechToTextUrlYoutube'), {
  fallback: <Loading />,
});
export const SpeechToTextUrlDrive = loadable(() =>
  import('./ArifScreen/SpeechToTextUrlDrive'), {
  fallback: <Loading />,
});
export const SpeechToTextFile = loadable(() =>
...
// Forms
export const FormikForm = loadable(() =>
  import('./Forms/FormikForm'), {
  fallback: <Loading />,
});
